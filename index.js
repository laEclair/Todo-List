...
function addLocalStorage () {
    ...
    for(let i = 0; i < jsonLS.length; i++ ){
        ...
        completedBtn.innerHTML = '&#9989';
        completedBtn.className = 'completedBtn';
        if(activeTask.style.backgroundColor == 'aquamarine'){
            completedBtn.addEventListener('click', uncomplited); 
        } else if (activeTask.style.backgroundColor == 'lavender') {
...
function buttonAddTask () {
    ...
    activeTask.className = 'activeTask';
    activeTask.style.backgroundColor = 'lavender';
...
function completed () {
    ...
    for(let i = 0; i < jsonLSComleted.length; i++ ){
        ...
        if(elem == jsonLSComleted[i].text){
            jsonLSComleted[i].colored = 'aquamarine';
...
function uncomplited() {   
    this.parentElement.style.backgroundColor = 'lavender';
    ...
    for(let i = 0; i < jsonLSComleted.length; i++ ){
        ...
        if(elem == jsonLSComleted[i].text){
            jsonLSComleted[i].colored = 'lavender';
